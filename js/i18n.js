const translations = {
  en: {
    ...
    contact: {
      ...
      salonTagline: 'Beauty & Pampering',
      salonAddress: 'Yaraicho 139, OS House 102, Shinjuku City, Tokyo',
      studioTitle: 'Tiyu Studio Tokyo',
      studioTagline: 'Art & Vintage',
      studioAddress: 'Waseda, Shinjuku City, Tokyo',
      openMaps: 'Open in Maps',
      messageUs: 'Message Us',
      instagram: 'Instagram',
      email: 'Email',
      address: 'Address',
      bottomNote: 'For appointment bookings, please use the Book Now button in the menu.',
    },
    services: {
      nails: 'Nails',
      lashes: 'Lashes',
    ...
    funnel: {
      ...
      preferencesDesc: 'Tell us your preferences for a personalized experience',
      nailTech: 'Nail Technician',
      noPreference: 'No Preference',
      languagePref: 'Language Preference',
      english: 'English Speaking',
      japanese: 'Japanese Speaking',
      friendRequest: 'I would like to bring a friend to sit next to me',
      friendShort: 'Friend Request',
      drinkPolicy: 'I understand and agree to the mandatory drink purchase (¥700) during my visit.',
      yes: 'Yes',
      no: 'No',
      specialNotes: 'Special Notes',
      notesPlaceholder: 'Any specific requests or details about your current nails...',
      proceedCalendar: 'Proceed to Calendar',
      ready: 'Ready to Book',
    ...
    estimator: {
      ...
      addOn: {
        charmL: { label: 'Charm L', desc: '+¥200 / charm' },
        charmM: { label: 'Charm M', desc: '+¥100 / charm' },
        charmS: { label: 'Charm S', desc: '+¥100 per 3 charms' },
        piercing: { label: 'Piercing', desc: '+¥200 / piercing' },
        pierceCharm: { label: 'Pierce Charm', desc: '+¥200 / charm' },
      },
      addOns: 'Add-ons & Charms',
      addOnsHint: 'Tap to add charms or piercings to this finger',
      allYouCanTake: 'All You Can Take Charms',
      allYouCanTakeDesc: 'Flat fee — disables individual charm costs',
      extensionAllFingers: 'Extensions (All Fingers)',
      extensionAllDesc: 'Flat +¥4,500 for all 10 fingers',
      fingerDetails: 'Finger Details',
      charmSPricing: 'Bundled in groups of 3',
    ...
    vintage: {
      heroTitle: 'Tiyu Vintage',
      heroSubtitle: 'Appointment-Only Designer Vintage Boutique',
      storyTitle: 'Our Story',
      storyBody: 'Inside Tiyu Studio Tokyo, we have created a small appointment-only vintage shop featuring carefully selected designer vintage bags. Every piece is personally sourced and selected by the owner with a focus on authenticity, quality, and value.',
      storySignature: '— The Tiyu Team',
      experienceTitle: 'The Experience',
      experienceBody: 'Pieces can be viewed by appointment at the studio or purchased online with shipping within Japan. Each bag comes with our guarantee of authenticity and careful inspection.',
      exploreCollection: 'Explore the Collection',
      followInstagram: 'Follow @tiyuvintagetokyo',
      requestViewing: 'Request Private Viewing',
      viewingNotes: 'Vintage private viewing request',
    },
    upload: {
  ...
  ja: {
    ...
    contact: {
      ...
      salonTitle: 'Tiyu Salon Tokyo',
      salonTagline: 'ビューティー＆パンプリング',
      salonAddress: '東京都新宿区矢来町139 OS House 102',
      studioTitle: 'Tiyu Studio Tokyo',
      studioTagline: 'アート＆ビンテージ',
      studioAddress: '東京都新宿区早稲田',
      openMaps: '地図で開く',
      messageUs: 'メッセージ',
      instagram: 'Instagram',
      email: 'メール',
      address: '住所',
      bottomNote: 'ご予約の際はメニューの「予約」ボタンをご利用ください。',
    },
    services: {
      nails: 'ネイル',
      lashes: 'まつ毛',
    ...
    funnel: {
      agreeContinue: '同意して次へ',
      preferences: 'ご希望',
      preferencesDesc: 'より快適なご体験のためにご希望をお聞かせください',
      nailTech: 'ネイリスト',
      noPreference: '指名なし',
      languagePref: '言語のご希望',
      english: '英語が話せるスタッフ',
      japanese: '日本語が話せるスタッフ',
      friendRequest: '隣に友人を同席させたい',
      friendShort: '友人同席',
      drinkPolicy: 'ご来店時のドリンクのご注文（¥700）に同意いたします。',
      yes: 'はい',
      no: 'いいえ',
      specialNotes: '特別なご要望',
      notesPlaceholder: 'ご要望や現在の爪の状態など...',
      proceedCalendar: 'カレンダーへ進む',
      ready: 'ご予約の準備ができました',
    ...
    estimator: {
      ...
      addOn: {
        charmL: { label: 'チャーム L', desc: '+¥200 / 個' },
        charmM: { label: 'チャーム M', desc: '+¥100 / 個' },
        charmS: { label: 'チャーム S', desc: '3個 +¥100' },
        piercing: { label: 'ピアッシング', desc: '+¥200 / 個' },
        pierceCharm: { label: 'ピアスチャーム', desc: '+¥200 / 個' },
      },
      addOns: '追加オプション・チャーム',
      addOnsHint: 'タップしてこの指にチャームやピアッシングを追加',
      allYouCanTake: 'チャーム詰め放題',
      allYouCanTakeDesc: '定額 — 個別チャーム料金は無効',
      extensionAllFingers: 'エクステンション（全指）',
      extensionAllDesc: '全10指 一律 +¥4,500',
      fingerDetails: '指の詳細',
      charmSPricing: '3個単位のセット価格',
    ...
    vintage: {
      heroTitle: 'Tiyu Vintage',
      heroSubtitle: '完全予約制デザイナービンテージブティック',
      storyTitle: '私たちの物語',
      storyBody: 'Tiyu Studio Tokyo内に、厳選されたデザイナービンテージバッグを集めた小さな完全予約制のショップを作りました。すべての品はオーナーが直接仕入れ、本物さ・品質・価値に焦点を当てて選んでいます。',
      storySignature: '— Tiyuより',
      experienceTitle: 'ご利用の流れ',
      experienceBody: '作品はスタジオでのご予約制でご覧いただけます。またはオンラインでご購入いただき、日本全国へ発送も可能です。各バッグには真贋保証と丁寧な検査が含まれます。',
      exploreCollection: 'コレクションを見る',
      followInstagram: '@tiyuvintagetokyoをフォロー',
      requestViewing: 'プライベートビューイングを依頼',
      viewingNotes: 'ビンテージプライベートビューイングの依頼',
    },
    upload: {
      title: 'Tiyuへインスポ',
