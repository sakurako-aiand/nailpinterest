...
const DATA = {
  feed: [
    ...
    { id: 'p2',  title: 'Silver Chrome Statement',   tier: 'complicated', category: 'nails', location: 'salon', image: img('7c92d2_8fafd4a5ed3b4536bf9ece852540a82c'),
    ...
    { id: 'p4',  title: 'Bold Glamour Set',          tier: 'intense',     category: 'nails', location: 'salon', image: img('7c92d2_4adb7e6d86264523a234d398c25746a9'),
    ...
    { id: 'p10', title: 'Intricate Detail Work',     tier: 'complicated', category: 'nails', location: 'salon', image: img('7c92d2_f556e83d6bc9468ca302f72c9009c048'),
    ...
    { id: 'p11', title: 'Jewel Tone Artistry',        tier: 'complicated', category: 'nails', location: 'salon', image: img('7c92d2_7089a93b863e4b5396243aa6815fb66b'),
      tags: ['#JewelTone', '#Black', '#Purple', '#Statement', '#Stiletto'],
      colors: [
        { label: 'Base',  brand: 'Holo Taco', color: 'One-Coat Black', swatch: 'black-swatch' },
        { label: 'Accent', brand: 'ILNP',      color: 'Deep Space',     swatch: 'purple-swatch' },
      ]},
    { id: 'p12', title: 'Sculptural 3D Art',          tier: 'complicated', category: 'nails', location: 'salon', image: img('7c92d2_6baa7226955b47fd863593eb58d00c08'),
    ...
    { id: 'p13', title: 'Graphic Statement Set',     tier: 'complicated', category: 'nails', location: 'salon', image: img('7c92d2_dcf94f43819e403f82cbe6ed7dd38ff3'),
    ...
    { id: 'p15', title: 'Editorial Bold',             tier: 'intense',     category: 'nails', location: 'salon', image: img('7c92d2_80e1c3d875894da5b0158e0a8fc831f1'),
    ...
    { id: 'p17', title: 'Avant-Garde Set',            tier: 'intense',     category: 'nails', location: 'salon', image: img('7c92d2_eec64f6d23ec46e6a66a638d6024d106'),
    ...
    { id: 'p18', title: 'Luxury Bridal Set',           tier: 'intense',     category: 'nails', location: 'salon', image: img('7c92d2_18b2a8c8d3ee4a22b2db4620bbbcbdec'),
    ...
    { id: 't6',  title: 'Elegant Wrist Piece',         category: 'tattoos', location: 'studio', image: img('7c92d2_f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2'),
      ...
      colors: [] },
    { id: 'po1', title: 'Pearl Press-On Set',          category: 'pressons', location: 'both', image: img('7c92d2_a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8'),
      tags: ['#Pearl', '#PressOn', '#White', '#Elegant', '#Reusable'],
      colors: [] },
    { id: 'po2', title: 'Chrome Press-On',             category: 'pressons', location: 'both', image: img('7c92d2_b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9'),
      tags: ['#Chrome', '#Silver', '#PressOn', '#Modern', '#Glossy'],
      colors: [] },
    { id: 'po3', title: 'Floral Art Press-On',         category: 'pressons', location: 'both', image: img('7c92d2_c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0'),
      tags: ['#Floral', '#Art', '#PressOn', '#Pink', '#HandPainted'],
      colors: [] },
    { id: 'po4', title: 'French Tip Press-On',         category: 'pressons', location: 'both', image: img('7c92d2_d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1'),
      tags: ['#FrenchTip', '#Classic', '#PressOn', '#White', '#CleanGirl'],
      colors: [] },
    { id: 'po5', title: 'Glitter Glam Press-On',       category: 'pressons', location: 'both', image: img('7c92d2_e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2'),
      tags: ['#Glitter', '#Glam', '#PressOn', '#Sparkle', '#Bold'],
      colors: [] },
    { id: 'po6', title: 'Nude Minimalist Press-On',    category: 'pressons', location: 'both', image: img('7c92d2_f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3'),
