...
const SERVICES = [
  ...
  { id: 'lashes',    label: 'Lashes',     jaLabel: 'まつ毛',     location: 'studio' },
  { id: 'brows',     label: 'Brows',      jaLabel: '眉',         location: 'studio' },
...
const DATA = {
  feed: [
    ...
    { id: 'l1',  title: 'Classic Natural Lashes',      category: 'lashes', location: 'studio',  image: img('7c92d2_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6'),
      tags: ['#Classic', '#Natural', '#Everyday', '#Lash', '#Soft'],
      colors: [] },
    { id: 'l2',  title: 'Dramatic Volume Set',         category: 'lashes', location: 'studio',  image: img('7c92d2_b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7'),
      tags: ['#Volume', '#Dramatic', '#Full', '#Lash', '#Bold'],
      colors: [] },
    { id: 'l3',  title: 'Wispy Cat Eye',               category: 'lashes', location: 'studio',  image: img('7c92d2_c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8'),
      tags: ['#Wispy', '#CatEye', '#Glamour', '#Lash', '#Winged'],
      colors: [] },
    { id: 'l4',  title: 'Mega Volume Bold',            category: 'lashes', location: 'studio',  image: img('7c92d2_d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9'),
      tags: ['#MegaVolume', '#Bold', '#Statement', '#Lash', '#Full'],
      colors: [] },
    { id: 'l5',  title: 'Soft Brown Lash Lift',         category: 'lashes', location: 'studio',  image: img('7c92d2_e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0'),
      tags: ['#LashLift', '#Natural', '#Brown', '#Lash', '#Everyday'],
      colors: [] },
    { id: 'l6',  title: 'Colored Lash Accents',        category: 'lashes', location: 'studio',  image: img('7c92d2_f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1'),
      tags: ['#Colored', '#Accent', '#Creative', '#Lash', '#Fun'],
      colors: [] },
    { id: 't1',  title: 'Fine Line Script',            category: 'tattoos', location: 'salon', image: img('7c92d2_a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7'),
      tags: ['#FineLine', '#Script', '#Minimalist', '#Tattoo', '#Small'],
      colors: [] },
    { id: 't2',  title: 'Botanical Fine Art',           category: 'tattoos', location: 'salon', image: img('7c92d2_b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8'),
      tags: ['#Botanical', '#Floral', '#FineLine', '#Tattoo', '#Nature'],
      colors: [] },
    { id: 't3',  title: 'Geometric Minimal',           category: 'tattoos', location: 'salon', image: img('7c92d2_c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9'),
      tags: ['#Geometric', '#Minimalist', '#Modern', '#Tattoo', '#Abstract'],
      colors: [] },
    { id: 't4',  title: 'Delicate Single Needle',      category: 'tattoos', location: 'salon', image: img('7c92d2_d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0'),
      tags: ['#SingleNeedle', '#Delicate', '#Detailed', '#Tattoo', '#Fine'],
      colors: [] },
    { id: 't5',  title: 'Micro Portrait Art',          category: 'tattoos', location: 'salon', image: img('7c92d2_e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1'),
      tags: ['#Micro', '#Portrait', '#Detailed', '#Tattoo', '#Art'],
      colors: [] },
    { id: 't6',  title: 'Elegant Wrist Piece',         category: 'tattoos', location: 'salon', image: img('7c92d2_f7a8b9c0d1e2f3a4b5c6d7e8f9a0b1c2'),
    ...
    { id: 'po6', title: 'Nude Minimalist Press-On',    category: 'pressons', location: 'studio', image: img('7c92d2_f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3'),
      ...
      colors: [] },
    { id: 'b1',  title: 'Sculpted Arch Brows',          category: 'brows', location: 'studio',   image: img('7c92d2_a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9'),
      tags: ['#Brows', '#Sculpted', '#Arch', '#Wax', '#Defined'],
      colors: [] },
    { id: 'b2',  title: 'Natural Hybrid Brow',           category: 'brows', location: 'studio',   image: img('7c92d2_b5c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0'),
      tags: ['#Brows', '#Hybrid', '#Natural', '#Perm', '#Lifted'],
      colors: [] },
    { id: 'b3',  title: 'Bold Feathered Brow',          category: 'brows', location: 'studio',   image: img('7c92d2_c6d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1'),
      tags: ['#Brows', '#Bold', '#Feathered', '#Full', '#Laminated'],
      colors: [] },
    { id: 'b4',  title: 'Soft Natural Brow Shape',       category: 'brows', location: 'studio',   image: img('7c92d2_d7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2'),
      tags: ['#Brows', '#Soft', '#Natural', '#Wax', '#Everyday'],
      colors: [] },
    { id: 'pe1', title: 'Classic Single Color Pedi',     category: 'pedicures', location: 'studio', image: img('7c92d2_a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0'),
      tags: ['#Pedicure', '#SingleColor', '#Classic', '#Glossy', '#Natural'],
      colors: [] },
    { id: 'pe2', title: 'French Tip Pedicure',           category: 'pedicures', location: 'studio', image: img('7c92d2_b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1'),
      tags: ['#Pedicure', '#FrenchTip', '#White', '#Classic', '#Clean'],
      colors: [] },
    { id: 'pe3', title: 'Chrome Cat Eye Pedi',           category: 'pedicures', location: 'studio', image: img('7c92d2_c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2'),
      tags: ['#Pedicure', '#Chrome', '#CatEye', '#Silver', '#Modern'],
      colors: [] },
    { id: 'pe4', title: 'Floral Design Pedi',            category: 'pedicures', location: 'studio', image: img('7c92d2_d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3'),
      tags: ['#Pedicure', '#Floral', '#Art', '#Pink', '#Detailed'],
      colors: [] },
    { id: 'pe5', title: 'Minimalist Nude Pedi',          category: 'pedicures', location: 'studio', image: img('7c92d2_e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4'),
